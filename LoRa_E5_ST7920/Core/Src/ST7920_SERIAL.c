...
void SendByteSPI(uint8_t byte)
{
	for(int i=0;i<8;i++)
	{
		if((byte<<i)&0x80)
			{
				HAL_GPIO_WritePin(ST7920_SID_GPIO_Port, ST7920_SID_Pin, GPIO_PIN_SET);  // SID=1  OR MOSI
			}

		else HAL_GPIO_WritePin(ST7920_SID_GPIO_Port, ST7920_SID_Pin, GPIO_PIN_RESET);  // SID=0

		HAL_GPIO_WritePin(ST7920_SCLK_GPIO_Port, ST7920_SCLK_Pin, GPIO_PIN_RESET);  // SCLK =0  OR SCK

		HAL_GPIO_WritePin(ST7920_SCLK_GPIO_Port, ST7920_SCLK_Pin, GPIO_PIN_SET);  // SCLK=1
...
void ST7920_SendCmd (uint8_t cmd)
{
	...
	HAL_GPIO_WritePin(ST7920_CS_GPIO_Port, ST7920_CS_Pin, GPIO_PIN_SET);  // PUll the CS high
	...
	HAL_GPIO_WritePin(ST7920_CS_GPIO_Port, ST7920_CS_Pin, GPIO_PIN_RESET);  // PUll the CS LOW
...
{
//	HAL_GPIO_WritePin(RST_PORT, ST7920_RST_PIN, GPIO_PIN_RESET);  // RESET=0
//	HAL_Delay(10);   // wait for 10ms
//	HAL_GPIO_WritePin(ST7920_RST_PORT, ST7920_RST_PIN, GPIO_PIN_SET);  // RESET=1
